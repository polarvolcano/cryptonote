...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x19; //starts with "p"
...
const char     CRYPTONOTE_NAME[]                             = "polarcoin";
...
const int      P2P_DEFAULT_PORT                              = 4459;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 4499;
...
const std::initializer_list<const char*> SEED_NODES = {
  "ec2-34-211-18-19.us-west-2.compute.amazonaws.com:4459",
